          ...
          <div className="lg:col-span-4 space-y-6">
            ...
            <div className="rounded-3xl bg-white border border-slate-200/80 overflow-hidden shadow-xl shadow-blue-500/5">
              ...
              <div className="p-6 pt-0 text-center relative space-y-4">
                ...
                <div>
                  ...
                  <div className="mt-2 inline-flex items-center gap-1 px-3 py-0.5 rounded-full bg-blue-100 text-[#2b89ff] text-[10px] font-extrabold uppercase">
            ...
            <div className="rounded-3xl bg-white border border-slate-200/80 p-6 shadow-xl shadow-blue-500/5 space-y-4">
              <div className="flex items-center justify-between">
                ...
                <span className="text-xs font-bold text-[#2b89ff] hover:underline cursor-pointer">View Certificate</span>
              </div>
                ...
                <table className="w-full text-left border-collapse">
                  <thead>
                    <tr className="border-b border-slate-100 text-[11px] font-extrabold text-slate-400 uppercase tracking-wider">
                      ...
                      <th className="py-3 px-3 text-[#2b89ff]">Booking ID</th>
                  ...
                  <tbody className="divide-y divide-slate-100 text-xs">
                    {bookings?.map((b) => (
                      <tr key={b.id} className="hover:bg-slate-50/80 transition-colors">
                        ...
                        <td className="py-3.5 px-3 font-mono font-bold text-[#2b89ff]">#{b.id}</td>
