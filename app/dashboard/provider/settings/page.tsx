          ...
          <div className="shrink-0 text-center">
            <div className="relative w-fit">
              {user?.avatarUrl ? (
                ...
                <div className="flex h-20 w-20 items-center justify-center rounded-2xl bg-gradient-to-br from-[#2c89ff] via-[#1c6df3] to-[#0946cd] text-3xl font-black text-white shadow-lg shadow-blue-500/25">
