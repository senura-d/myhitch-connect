...
const NAV = [
  { href: "/dashboard/customer", label: "Overview", icon: IconLayoutDashboard },
  { href: "/dashboard/customer/bookings", label: "My Bookings", icon: IconCheckbox },
  { href: "/dashboard/customer/services", label: "Services", icon: IconBox },
  { href: "/dashboard/customer/profile", label: "Profile & Account", icon: IconUsers },
  { href: "/dashboard/customer/support", label: "Help & Support", icon: IconHelpCircle },
  { href: "/dashboard/customer/settings", label: "Settings", icon: IconSettings },
];
