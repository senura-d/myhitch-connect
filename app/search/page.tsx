  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#f8fafc] font-sans text-slate-900 overflow-x-clip">
      ...
      <main className="flex-1 overflow-x-clip">
        {/* HERO WAVE BACKDROP */}
        <section className="relative overflow-hidden bg-gradient-to-br from-[#2c89ff] via-[#1c6df3] to-[#0946cd] text-white py-14 lg:py-16">
          <svg
          ...
          <div className="p-4 sm:p-5 rounded-2xl bg-white border border-slate-200/80 shadow-lg shadow-blue-500/5 mb-8">
            <div className="flex items-center justify-between font-black text-xs text-slate-900 mb-3 border-b border-slate-100 pb-2.5">
              <div className="flex items-center gap-2">
                <IconFilter className="h-4 w-4 text-[#2b89ff]" />
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 items-end">
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative flex items-center">
                  <IconSearch className="absolute left-3.5 top-1/2 -translate-y-1/2 h-4 w-4 text-[#2b89ff] z-10 pointer-events-none" />
                  <Input
                    placeholder="e.g. Plumbing, Cleaning"
                    value={query}
                    onChange={(e) => setQuery(e.target.value)}
                    className="h-10 border border-slate-200 border-l-4 border-l-[#2b89ff] bg-[#f4f6fa] !pl-10 text-xs font-medium text-slate-900 placeholder:text-slate-400 focus-visible:bg-white focus-visible:ring-1 focus-visible:ring-[#2b89ff] rounded-r-xl rounded-l-none transition-all"
                  />
                </div>
              </div>
              ...
              <div className="space-y-1.5">
                ...
                <select
                  ...
                  className="w-full h-10 px-3.5 text-xs font-semibold rounded-r-xl rounded-l-none border border-slate-200 border-l-4 border-l-[#2b89ff] bg-[#f4f6fa] text-slate-900 focus:outline-none focus:bg-white focus:ring-1 focus:ring-[#2b89ff] transition-all"
                >
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative flex items-center">
                  <IconMapPin className="absolute left-3.5 top-1/2 -translate-y-1/2 h-4 w-4 text-[#2b89ff] z-10 pointer-events-none" />
                  <Input
            ...
            {isLoading ? (
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-5">
                {results?.map(({ listing, provider }) => (
                  <Card key={listing.id} className="overflow-hidden rounded-2xl hover:border-[#2b89ff] hover:shadow-xl hover:shadow-blue-500/10 transition-all duration-300 flex flex-col justify-between border border-slate-200/80 bg-white pt-0">
                    <div className="relative h-36 w-full bg-slate-100 overflow-hidden">
                      ...
                      <div className="absolute top-2.5 right-2.5">
                        <Badge variant="secondary" className="capitalize text-[9px] bg-white/95 text-[#2b89ff] border border-[#2b89ff]/30 font-extrabold px-2 py-0.5 shadow-xs">
                    ...
                    <CardHeader className="p-4 pb-1.5 space-y-1">
                      <CardTitle className="text-xs sm:text-sm font-extrabold line-clamp-1 text-slate-900 hover:text-[#2b89ff] transition-colors">
