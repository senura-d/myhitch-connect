              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  <Input
                    ...
                    className="h-10 border border-slate-200 bg-slate-50 font-mono text-xs font-bold text-slate-800 rounded-full focus-visible:bg-white focus-visible:ring-1 focus-visible:ring-[#2b89ff]"
                  />
                </div>
