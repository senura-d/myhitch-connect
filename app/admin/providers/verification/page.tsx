          ...
          <div className="rounded-3xl bg-white border border-slate-200/80 overflow-hidden shadow-xl shadow-blue-500/5">
            ...
            <div className="p-6 pt-0 text-center relative space-y-4">
              <div className="relative -mt-14 inline-block">
                <div className="h-24 w-24 rounded-full border-4 border-white overflow-hidden shadow-lg relative mx-auto bg-slate-100 flex items-center justify-center text-[#2b89ff]">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
            ...
            <div className="p-4 rounded-3xl bg-white border border-slate-200/80 shadow-xs space-y-2">
              <div className="flex items-center justify-between">
                ...
                <span className="text-[10px] font-extrabold px-1.5 py-0.5 rounded-full bg-blue-100 text-[#2b89ff]">Active</span>
              </div>
              <div>
                <span className="text-[11px] font-bold text-slate-400 block">Active Listings</span>
                <span className="text-xl font-black text-[#2b89ff]">{stats?.activeListings || 0}</span>
              </div>
            </div>
              ...
              <table className="w-full text-left border-collapse">
                <thead>
                  <tr className="border-b border-slate-100 text-[11px] font-extrabold text-slate-400 uppercase tracking-wider">
                    ...
                    <th className="py-3 px-3 text-[#2b89ff]">Type</th>
                  ...
                  {queue?.map((provider) => (
                    <tr key={provider.id} className="hover:bg-slate-50/80 transition-colors">
                      ...
                      <td className="py-3.5 px-3 font-bold text-slate-900">
                        <Link href={`/provider/${provider.id}`} className="hover:underline text-[#2b89ff]">
