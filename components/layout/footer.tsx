          ...
          <form onSubmit={handleSubscribe} className="flex flex-col gap-3 sm:flex-row">
            <div className="relative flex-1">
              ...
              <input
                ...
                className="h-12 w-full border-0 border-l-4 border-l-[#2b89ff] bg-[#f4f6fa] pl-11 pr-4 text-sm font-medium text-slate-800 placeholder:text-slate-400 transition-all focus:bg-white focus:outline-none focus:ring-1 focus:ring-[#2b89ff] rounded-r-xl rounded-l-none"
              />
            </div>
            <button
              type="submit"
              className="group inline-flex h-12 shrink-0 items-center justify-center gap-2 rounded-full bg-[#1b76ff] px-6 text-xs font-bold uppercase tracking-widest text-white shadow-md shadow-blue-500/20 transition-all hover:bg-[#145ed8] hover:shadow-lg hover:shadow-blue-500/30 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#2b89ff]"
            >
              <span>Subscribe</span>
              <IconArrowRight
                aria-hidden="true"
