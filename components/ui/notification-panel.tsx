  ...
  return (
    <div className="relative" ref={panelRef}>
      <button
        ...
        aria-haspopup="true"
        onClick={() => setOpen((v) => !v)}
        className="relative rounded-full p-2 text-slate-500 transition-colors hover:bg-slate-100 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#2b89ff]/40"
      >
          ...
          <div className="flex items-center justify-between border-b border-slate-100 px-5 py-4">
            ...
            {unreadCount > 0 && (
              <button
                type="button"
                onClick={markAllRead}
                className="flex items-center gap-1 text-[11px] font-bold text-[#2b89ff] transition-colors hover:text-[#1b76ff]"
              >
                ...
                const body = (
                  <>
                    ...
                    {!n.read && (
                      <span
                        aria-hidden="true"
                        className="mt-1.5 h-2 w-2 shrink-0 rounded-full bg-[#2b89ff]"
                      />
                    )}
                  </>
                );
                ...
                return (
                  ...
                  >
                    ...
                    <button
                      ...
                      className="absolute right-3 top-4 rounded-md p-1 text-slate-300 transition-colors hover:text-slate-500 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#2b89ff]/40"
                    >
